namespace Microsoft.Graph.Core.Test.Extensions
{
    ...
    [TestClass]
    public class BaseRequestExtensionsTests: BaseRequestTests
    {
        ...
        public void WithScopes_ShouldAddScopesToAuthOption()
        {
            ...
            Assert.IsInstanceOfType(baseRequest.GetHttpRequestMessage().Properties[typeof(RequestContext).ToString()], typeof(RequestContext), "Unexpected request context.");
        ...
        public void WithForceRefresh_ShouldAddForceRefreshToAuthOption()
        {
            ...
            Assert.IsInstanceOfType(request.GetHttpRequestMessage().Properties[typeof(RequestContext).ToString()], typeof(RequestContext), "Unexpected request context.");
