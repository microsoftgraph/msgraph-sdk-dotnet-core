    ...
    public class HttpProviderTests
    {
        ...
        public async Task SendAsync_ClientGeneralException()
        {
            using (var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, "https://localhost"))
            {
                ...
                catch (ServiceException exception)
                {
                    ...
                    Assert.AreEqual(GraphErrorCode.GeneralException.ToString(), exception.Error.Code, "Incorrect error code returned.");
        ...
        public async Task SendAsync_ClientTimeout()
        {
            using (var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, "https://localhost"))
            {
                ...
                {
                    Assert.IsNotNull(exception.Error, "No error body returned.");
                    Assert.AreEqual(GraphErrorCode.Timeout.ToString(), exception.Error.Code, "Incorrect error code returned.");
        ...
        public async Task SendAsync_InvalidRedirectResponse()
        {
            ...
            using (var httpResponseMessage = new HttpResponseMessage())
            {
                ...
                catch (ServiceException exception)
                {
                    ...
                    Assert.AreEqual(GraphErrorCode.GeneralException.ToString(), exception.Error.Code, "Unexpected error code returned.");
                    Assert.AreEqual(
        ...
        public async Task SendAsync_MaxRedirects()
        {
            ...
            using (var tooManyRedirectsResponseMessage = new HttpResponseMessage())
            {
                ...
                {
                    Assert.IsNotNull(exception.Error, "Error not set in exception.");
                    Assert.AreEqual(GraphErrorCode.TooManyRedirects.ToString(), exception.Error.Code, "Unexpected error code returned.");
                    Assert.AreEqual(
        ...
        public async Task SendAsync_NotFoundWithoutErrorBody()
        {
            ...
            using (var httpResponseMessage = new HttpResponseMessage())
            {
                ...
                {
                    Assert.IsNotNull(exception.Error, "No error body returned.");
                    Assert.AreEqual(GraphErrorCode.ItemNotFound.ToString(), exception.Error.Code, "Incorrect error code returned.");
        ...
        public async Task SendAsync_NotFoundWithBody()
        {
            ...
            using (var httpResponseMessage = new HttpResponseMessage())
            {
                ...
                var notFoundErrorString = GraphErrorCode.ItemNotFound.ToString();
