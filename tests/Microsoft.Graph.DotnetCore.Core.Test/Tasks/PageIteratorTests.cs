    ...
    **/
    public class PageIteratorTests
    {
        ...
        public async Task Given_CollectionPage_It_Iterates_Across_Pages()
        {
            ...
            this.mockRequestAdapter.Setup(x => x.SendAsync<TestEventsResponse>(It.IsAny<RequestInformation>(), It.IsAny<IResponseHandler>(), It.IsAny<Dictionary<string, Func<IParsable>>>(), It.IsAny<CancellationToken>()))
