...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookFunctionsErfRequestBody
    {
        ...
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore, PropertyName = "lowerLimit", Required = Required.Default)]
        public Newtonsoft.Json.Linq.JToken LowerLimit { get; set; }
    
        /// <summary>
        /// Gets or sets UpperLimit.
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore, PropertyName = "upperLimit", Required = Required.Default)]
