...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookFunctionsConvertRequestBody
    {
        ...
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore, PropertyName = "fromUnit", Required = Required.Default)]
        public Newtonsoft.Json.Linq.JToken FromUnit { get; set; }
    
        /// <summary>
        /// Gets or sets ToUnit.
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore, PropertyName = "toUnit", Required = Required.Default)]
