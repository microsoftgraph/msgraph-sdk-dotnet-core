...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ManagedEBookCategoriesCollectionReferencesRequest.
    /// </summary>
    public partial class ManagedEBookCategoriesCollectionReferencesRequest : BaseRequest, IManagedEBookCategoriesCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new ManagedEBookCategoriesCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ManagedEBookCategoriesCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
