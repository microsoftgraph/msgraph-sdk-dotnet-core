...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IManagedAppRegistrationAppliedPoliciesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IManagedAppRegistrationAppliedPoliciesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IManagedAppRegistrationAppliedPoliciesCollectionRequest Request(IEnumerable<Option> options);
