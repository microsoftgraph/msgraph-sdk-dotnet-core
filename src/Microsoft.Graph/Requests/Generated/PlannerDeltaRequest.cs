...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PlannerDeltaRequest.
    /// </summary>
    public partial class PlannerDeltaRequest : BaseRequest, IPlannerDeltaRequest
    {
        /// <summary>
        /// Constructs a new PlannerDeltaRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PlannerDeltaRequest(
            string requestUrl,
            IBaseClient client,
        ...
        {
            this.Method = "DELETE";
            await this.SendAsync<PlannerDelta>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<PlannerDelta> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The PlannerDelta.</returns>
        public async System.Threading.Tasks.Task<PlannerDelta> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<PlannerDelta>(null, cancellationToken).ConfigureAwait(false);
        ...
        public System.Threading.Tasks.Task<PlannerDelta> UpdateAsync(PlannerDelta plannerDeltaToUpdate)
        {
            return this.UpdateAsync(plannerDeltaToUpdate, CancellationToken.None);
        }
        ...
        public IPlannerDeltaRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPlannerDeltaRequest Expand(Expression<Func<PlannerDelta, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPlannerDeltaRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPlannerDeltaRequest Select(Expression<Func<PlannerDelta, object>> selectExpression)
        {
