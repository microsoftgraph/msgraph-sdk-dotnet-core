...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IGovernanceResourceRoleAssignmentsCollectionRequestBuilder.
    /// </summary>
    public partial interface IGovernanceResourceRoleAssignmentsCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IGovernanceResourceRoleAssignmentsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IGovernanceResourceRoleAssignmentsCollectionRequest Request(IEnumerable<Option> options);
