...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type TargetedManagedAppConfigurationTargetedSecurityGroupsCollectionReferencesRequest.
    /// </summary>
    public partial class TargetedManagedAppConfigurationTargetedSecurityGroupsCollectionReferencesRequest : BaseRequest, ITargetedManagedAppConfigurationTargetedSecurityGroupsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new TargetedManagedAppConfigurationTargetedSecurityGroupsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public TargetedManagedAppConfigurationTargetedSecurityGroupsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
