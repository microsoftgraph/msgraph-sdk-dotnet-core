...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IUserDrivesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IUserDrivesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IUserDrivesCollectionRequest Request(IEnumerable<Option> options);
