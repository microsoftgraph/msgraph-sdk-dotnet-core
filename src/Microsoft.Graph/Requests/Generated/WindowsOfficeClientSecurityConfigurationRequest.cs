...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type WindowsOfficeClientSecurityConfigurationRequest.
    /// </summary>
    public partial class WindowsOfficeClientSecurityConfigurationRequest : BaseRequest, IWindowsOfficeClientSecurityConfigurationRequest
    {
        /// <summary>
        /// Constructs a new WindowsOfficeClientSecurityConfigurationRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public WindowsOfficeClientSecurityConfigurationRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<WindowsOfficeClientSecurityConfiguration> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The WindowsOfficeClientSecurityConfiguration.</returns>
        public async System.Threading.Tasks.Task<WindowsOfficeClientSecurityConfiguration> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<WindowsOfficeClientSecurityConfiguration>(null, cancellationToken).ConfigureAwait(false);
        ...
        public IWindowsOfficeClientSecurityConfigurationRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsOfficeClientSecurityConfigurationRequest Expand(Expression<Func<WindowsOfficeClientSecurityConfiguration, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsOfficeClientSecurityConfigurationRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsOfficeClientSecurityConfigurationRequest Select(Expression<Func<WindowsOfficeClientSecurityConfiguration, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="windowsOfficeClientSecurityConfigurationToInitialize">The <see cref="WindowsOfficeClientSecurityConfiguration"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(WindowsOfficeClientSecurityConfiguration windowsOfficeClientSecurityConfigurationToInitialize)
        {
