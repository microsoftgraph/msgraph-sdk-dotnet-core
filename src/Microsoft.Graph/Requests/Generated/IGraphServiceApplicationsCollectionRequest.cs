...
namespace Microsoft.Graph
{
    ...
    public partial interface IGraphServiceApplicationsCollectionRequest : IBaseRequest
    {
        ...
        IGraphServiceApplicationsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceApplicationsCollectionRequest Expand(Expression<Func<Application, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceApplicationsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceApplicationsCollectionRequest Select(Expression<Func<Application, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceApplicationsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceApplicationsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceApplicationsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceApplicationsCollectionRequest OrderBy(string value);
    }
}
