...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class InvitationRequestBuilder : EntityRequestBuilder, IInvitationRequestBuilder
    {
        ...
        public InvitationRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public new IInvitationRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new IInvitationRequest Request(IEnumerable<Option> options)
        {
            return new InvitationRequest(this.RequestUrl, this.Client, options);
        }
