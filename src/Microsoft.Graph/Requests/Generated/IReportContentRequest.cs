...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IReportContentRequest : IBaseRequest
    {
        /// <summary>
        /// Gets the stream.
        /// </summary>
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream content) where T : Report;
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : Report;
