...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface INotificationMessageTemplateRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new INotificationMessageTemplateRequest Request();
        ...
        /// <returns>The built request.</returns>
        new INotificationMessageTemplateRequest Request(IEnumerable<Option> options);
        ...
        INotificationMessageTemplateLocalizedNotificationMessagesCollectionRequestBuilder LocalizedNotificationMessages { get; }
