    ...
    public partial class MobileAppRequest : BaseRequest, IMobileAppRequest
    {
        ...
        private void InitializeCollectionProperties(MobileApp mobileAppToInitialize)
        {
            ...
            if (mobileAppToInitialize != null && mobileAppToInitialize.AdditionalData != null)
            {
                ...
                if (mobileAppToInitialize.GroupAssignments != null && mobileAppToInitialize.GroupAssignments.CurrentPage != null)
                {
                    mobileAppToInitialize.GroupAssignments.AdditionalData = mobileAppToInitialize.AdditionalData;

                    object nextPageLink;
                    mobileAppToInitialize.AdditionalData.TryGetValue("groupAssignments@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        mobileAppToInitialize.GroupAssignments.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
