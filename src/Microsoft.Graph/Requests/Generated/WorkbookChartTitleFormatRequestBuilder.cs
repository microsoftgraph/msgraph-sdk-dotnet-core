...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookChartTitleFormatRequestBuilder : EntityRequestBuilder, IWorkbookChartTitleFormatRequestBuilder
    {
        ...
        public new IWorkbookChartTitleFormatRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new IWorkbookChartTitleFormatRequest Request(IEnumerable<Option> options)
        {
            return new WorkbookChartTitleFormatRequest(this.RequestUrl, this.Client, options);
        }
