...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookChartAreaFormatRequestBuilder : EntityRequestBuilder, IWorkbookChartAreaFormatRequestBuilder
    {
        ...
        public WorkbookChartAreaFormatRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public new IWorkbookChartAreaFormatRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new IWorkbookChartAreaFormatRequest Request(IEnumerable<Option> options)
        {
            return new WorkbookChartAreaFormatRequest(this.RequestUrl, this.Client, options);
        }
