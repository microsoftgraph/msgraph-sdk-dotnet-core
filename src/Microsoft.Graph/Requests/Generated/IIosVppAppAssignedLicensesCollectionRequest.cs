...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IIosVppAppAssignedLicensesCollectionRequest.
    /// </summary>
    public partial interface IIosVppAppAssignedLicensesCollectionRequest : IBaseRequest
    {
        ...
        IIosVppAppAssignedLicensesCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IIosVppAppAssignedLicensesCollectionRequest Expand(Expression<Func<IosVppAppAssignedLicense, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IIosVppAppAssignedLicensesCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IIosVppAppAssignedLicensesCollectionRequest Select(Expression<Func<IosVppAppAssignedLicense, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IIosVppAppAssignedLicensesCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IIosVppAppAssignedLicensesCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IIosVppAppAssignedLicensesCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IIosVppAppAssignedLicensesCollectionRequest OrderBy(string value);
    }
}
