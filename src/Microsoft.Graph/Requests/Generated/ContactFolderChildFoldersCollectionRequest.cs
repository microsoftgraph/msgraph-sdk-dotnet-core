...
namespace Microsoft.Graph
{
    ...
    public partial class ContactFolderChildFoldersCollectionRequest : BaseRequest, IContactFolderChildFoldersCollectionRequest
    {
        ...
        /// <returns>The created ContactFolder.</returns>
        public Task<ContactFolder> AddAsync(ContactFolder contactFolder, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IContactFolderChildFoldersCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
