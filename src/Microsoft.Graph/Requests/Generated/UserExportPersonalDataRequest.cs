...
namespace Microsoft.Graph
{
    ...
    public partial class UserExportPersonalDataRequest : BaseRequest, IUserExportPersonalDataRequest
    {
        ...
        /// </summary>
        public UserExportPersonalDataRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new UserExportPersonalDataRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public UserExportPersonalDataRequestBody RequestBody { get; private set; }
        ...
        public IUserExportPersonalDataRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUserExportPersonalDataRequest Select(string value)
        {
