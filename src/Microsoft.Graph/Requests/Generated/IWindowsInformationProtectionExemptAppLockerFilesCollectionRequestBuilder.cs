...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IWindowsInformationProtectionExemptAppLockerFilesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IWindowsInformationProtectionExemptAppLockerFilesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IWindowsInformationProtectionExemptAppLockerFilesCollectionRequest Request(IEnumerable<Option> options);
