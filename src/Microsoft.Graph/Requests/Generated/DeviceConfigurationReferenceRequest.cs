...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceConfigurationReferenceRequest.
    /// </summary>
    public partial class DeviceConfigurationReferenceRequest : BaseRequest, IDeviceConfigurationReferenceRequest
    {
        /// <summary>
        /// Constructs a new DeviceConfigurationReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DeviceConfigurationReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified DeviceConfiguration reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified DeviceConfiguration reference.
        /// </summary>
        /// <param name="id">The DeviceConfiguration reference to update.</param>
        /// <returns>The task to await.</returns>
