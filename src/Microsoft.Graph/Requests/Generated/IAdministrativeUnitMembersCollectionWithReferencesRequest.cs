...
namespace Microsoft.Graph
{
    ...
    public partial interface IAdministrativeUnitMembersCollectionWithReferencesRequest : IBaseRequest
    {
        ...
        IAdministrativeUnitMembersCollectionWithReferencesRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IAdministrativeUnitMembersCollectionWithReferencesRequest Expand(Expression<Func<DirectoryObject, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IAdministrativeUnitMembersCollectionWithReferencesRequest Select(Expression<Func<DirectoryObject, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IAdministrativeUnitMembersCollectionWithReferencesRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IAdministrativeUnitMembersCollectionWithReferencesRequest Skip(int value);
