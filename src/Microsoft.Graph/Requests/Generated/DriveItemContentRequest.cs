...
namespace Microsoft.Graph
{
    ...
    public partial class DriveItemContentRequest : BaseRequest, IDriveItemContentRequest
    {
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        public Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : DriveItem
        {
