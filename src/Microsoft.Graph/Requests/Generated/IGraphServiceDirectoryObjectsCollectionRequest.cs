...
namespace Microsoft.Graph
{
    ...
    public partial interface IGraphServiceDirectoryObjectsCollectionRequest : IBaseRequest
    {
        ...
        IGraphServiceDirectoryObjectsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDirectoryObjectsCollectionRequest Expand(Expression<Func<DirectoryObject, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDirectoryObjectsCollectionRequest Select(Expression<Func<DirectoryObject, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDirectoryObjectsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDirectoryObjectsCollectionRequest Skip(int value);
