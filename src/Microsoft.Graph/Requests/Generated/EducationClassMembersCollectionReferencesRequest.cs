...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class EducationClassMembersCollectionReferencesRequest : BaseRequest, IEducationClassMembersCollectionReferencesRequest
    {
        /// <summary>
        ...
        public EducationClassMembersCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task AddAsync(EducationUser educationUser, CancellationToken cancellationToken)
        {
            ...
            var requestBody = new ReferenceRequestBody { ODataId = string.Format("{0}/education/members/{1}", this.Client.BaseUrl, educationUser.Id) };
