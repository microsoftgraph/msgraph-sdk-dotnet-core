...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IEducationUserWithReferenceRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IEducationUserWithReferenceRequest Request();
        ...
        /// <returns>The built request.</returns>
        IEducationUserWithReferenceRequest Request(IEnumerable<Option> options);
        ...
        IEducationUserReferenceRequestBuilder Reference { get; }
