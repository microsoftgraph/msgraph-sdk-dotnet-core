...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type WindowsCertificateProfileBaseReferenceRequest.
    /// </summary>
    public partial class WindowsCertificateProfileBaseReferenceRequest : BaseRequest, IWindowsCertificateProfileBaseReferenceRequest
    {
        /// <summary>
        /// Constructs a new WindowsCertificateProfileBaseReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public WindowsCertificateProfileBaseReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified WindowsCertificateProfileBase reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified WindowsCertificateProfileBase reference.
        /// </summary>
        /// <param name="id">The WindowsCertificateProfileBase reference to update.</param>
        /// <returns>The task to await.</returns>
