...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IPrivilegedRoleSettingsReferenceRequest.
    /// </summary>
    public partial interface IPrivilegedRoleSettingsReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="id">The PrivilegedRoleSettings reference reference to update.</param>
        /// <returns>The task to await.</returns>
