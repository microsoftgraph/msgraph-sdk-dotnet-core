...
namespace Microsoft.Graph
{
    ...
    public partial interface IOutlookTaskFolderSingleValueExtendedPropertiesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IOutlookTaskFolderSingleValueExtendedPropertiesCollectionPage> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IOutlookTaskFolderSingleValueExtendedPropertiesCollectionPage> GetAsync(CancellationToken cancellationToken);
