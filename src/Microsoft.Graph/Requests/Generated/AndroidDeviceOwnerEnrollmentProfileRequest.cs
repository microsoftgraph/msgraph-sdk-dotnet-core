...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AndroidDeviceOwnerEnrollmentProfileRequest.
    /// </summary>
    public partial class AndroidDeviceOwnerEnrollmentProfileRequest : BaseRequest, IAndroidDeviceOwnerEnrollmentProfileRequest
    {
        /// <summary>
        /// Constructs a new AndroidDeviceOwnerEnrollmentProfileRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AndroidDeviceOwnerEnrollmentProfileRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<AndroidDeviceOwnerEnrollmentProfile> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The AndroidDeviceOwnerEnrollmentProfile.</returns>
        public async System.Threading.Tasks.Task<AndroidDeviceOwnerEnrollmentProfile> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<AndroidDeviceOwnerEnrollmentProfile>(null, cancellationToken).ConfigureAwait(false);
        ...
        public IAndroidDeviceOwnerEnrollmentProfileRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IAndroidDeviceOwnerEnrollmentProfileRequest Expand(Expression<Func<AndroidDeviceOwnerEnrollmentProfile, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IAndroidDeviceOwnerEnrollmentProfileRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IAndroidDeviceOwnerEnrollmentProfileRequest Select(Expression<Func<AndroidDeviceOwnerEnrollmentProfile, object>> selectExpression)
        {
        ...
        /// </summary>
        /// <param name="androidDeviceOwnerEnrollmentProfileToInitialize">The <see cref="AndroidDeviceOwnerEnrollmentProfile"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(AndroidDeviceOwnerEnrollmentProfile androidDeviceOwnerEnrollmentProfileToInitialize)
        {
