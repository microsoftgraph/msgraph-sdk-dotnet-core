...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type SectionCopyToNotebookRequestBuilder.
    /// </summary>
    public partial class SectionCopyToNotebookRequestBuilder : BaseActionMethodRequestBuilder<ISectionCopyToNotebookRequest>, ISectionCopyToNotebookRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="SectionCopyToNotebookRequestBuilder"/>.
        /// </summary>
        ...
        public SectionCopyToNotebookRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string id,
            string groupId,
        ...
        protected override ISectionCopyToNotebookRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new SectionCopyToNotebookRequest(functionUrl, this.Client, options);
