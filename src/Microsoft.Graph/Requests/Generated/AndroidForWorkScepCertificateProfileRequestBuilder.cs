...
namespace Microsoft.Graph
{
    ...
    public partial class AndroidForWorkScepCertificateProfileRequestBuilder : AndroidForWorkCertificateProfileBaseRequestBuilder, IAndroidForWorkScepCertificateProfileRequestBuilder
    {
        ...
        public IAndroidForWorkScepCertificateProfileManagedDeviceCertificateStatesCollectionRequestBuilder ManagedDeviceCertificateStates
        {
            get
            {
                return new AndroidForWorkScepCertificateProfileManagedDeviceCertificateStatesCollectionRequestBuilder(this.AppendSegmentToRequestUrl("managedDeviceCertificateStates"), this.Client);
            }
        }
