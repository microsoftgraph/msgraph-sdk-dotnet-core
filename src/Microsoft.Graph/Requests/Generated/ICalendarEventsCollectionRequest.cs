...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ICalendarEventsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<ICalendarEventsCollectionPage> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<ICalendarEventsCollectionPage> GetAsync(CancellationToken cancellationToken);
        ...
        /// <returns>The request object to send.</returns>
        ICalendarEventsCollectionRequest Expand(Expression<Func<Event, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        ICalendarEventsCollectionRequest Select(Expression<Func<Event, object>> selectExpression);
