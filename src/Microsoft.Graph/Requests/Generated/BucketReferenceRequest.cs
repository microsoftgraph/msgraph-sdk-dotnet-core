...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type BucketReferenceRequest.
    /// </summary>
    public partial class BucketReferenceRequest : BaseRequest, IBucketReferenceRequest
    {
        /// <summary>
        /// Constructs a new BucketReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public BucketReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified Bucket reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified Bucket reference.
        /// </summary>
        /// <param name="id">The Bucket reference to update.</param>
        /// <returns>The task to await.</returns>
