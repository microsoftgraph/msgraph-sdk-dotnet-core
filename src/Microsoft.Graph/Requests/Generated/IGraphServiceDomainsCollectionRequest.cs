...
namespace Microsoft.Graph
{
    ...
    public partial interface IGraphServiceDomainsCollectionRequest : IBaseRequest
    {
        ...
        IGraphServiceDomainsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDomainsCollectionRequest Expand(Expression<Func<Domain, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDomainsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDomainsCollectionRequest Select(Expression<Func<Domain, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDomainsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDomainsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDomainsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceDomainsCollectionRequest OrderBy(string value);
    }
}
