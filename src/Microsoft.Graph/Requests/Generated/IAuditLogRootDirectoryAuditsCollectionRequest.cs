...
namespace Microsoft.Graph
{
    ...
    public partial interface IAuditLogRootDirectoryAuditsCollectionRequest : IBaseRequest
    {
        ...
        IAuditLogRootDirectoryAuditsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IAuditLogRootDirectoryAuditsCollectionRequest Expand(Expression<Func<DirectoryAudit, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IAuditLogRootDirectoryAuditsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IAuditLogRootDirectoryAuditsCollectionRequest Select(Expression<Func<DirectoryAudit, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IAuditLogRootDirectoryAuditsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IAuditLogRootDirectoryAuditsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IAuditLogRootDirectoryAuditsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IAuditLogRootDirectoryAuditsCollectionRequest OrderBy(string value);
    }
}
