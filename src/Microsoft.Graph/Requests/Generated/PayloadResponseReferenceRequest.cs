...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PayloadResponseReferenceRequest.
    /// </summary>
    public partial class PayloadResponseReferenceRequest : BaseRequest, IPayloadResponseReferenceRequest
    {
        /// <summary>
        /// Constructs a new PayloadResponseReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PayloadResponseReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The PayloadResponse reference to update.</param>
        /// <returns>The task to await.</returns>
