...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ApplicationPoliciesCollectionReferencesRequest.
    /// </summary>
    public partial class ApplicationPoliciesCollectionReferencesRequest : BaseRequest, IApplicationPoliciesCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new ApplicationPoliciesCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ApplicationPoliciesCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
