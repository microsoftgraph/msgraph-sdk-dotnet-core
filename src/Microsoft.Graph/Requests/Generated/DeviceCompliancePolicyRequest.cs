    ...
    public partial class DeviceCompliancePolicyRequest : BaseRequest, IDeviceCompliancePolicyRequest
    {
        ...
        private void InitializeCollectionProperties(DeviceCompliancePolicy deviceCompliancePolicyToInitialize)
        {
            ...
            if (deviceCompliancePolicyToInitialize != null && deviceCompliancePolicyToInitialize.AdditionalData != null)
            {
                ...
                if (deviceCompliancePolicyToInitialize.GroupAssignments != null && deviceCompliancePolicyToInitialize.GroupAssignments.CurrentPage != null)
                {
                    deviceCompliancePolicyToInitialize.GroupAssignments.AdditionalData = deviceCompliancePolicyToInitialize.AdditionalData;

                    object nextPageLink;
                    deviceCompliancePolicyToInitialize.AdditionalData.TryGetValue("groupAssignments@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        deviceCompliancePolicyToInitialize.GroupAssignments.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
