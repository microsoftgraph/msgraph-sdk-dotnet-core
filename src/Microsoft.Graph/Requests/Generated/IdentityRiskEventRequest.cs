...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type IdentityRiskEventRequest.
    /// </summary>
    public partial class IdentityRiskEventRequest : BaseRequest, IIdentityRiskEventRequest
    {
        /// <summary>
        /// Constructs a new IdentityRiskEventRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public IdentityRiskEventRequest(
            string requestUrl,
            IBaseClient client,
        ...
        {
            this.Method = "DELETE";
            await this.SendAsync<IdentityRiskEvent>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public System.Threading.Tasks.Task<IdentityRiskEvent> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The IdentityRiskEvent.</returns>
        public async System.Threading.Tasks.Task<IdentityRiskEvent> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<IdentityRiskEvent>(null, cancellationToken).ConfigureAwait(false);
        ...
        public System.Threading.Tasks.Task<IdentityRiskEvent> UpdateAsync(IdentityRiskEvent identityRiskEventToUpdate)
        {
            return this.UpdateAsync(identityRiskEventToUpdate, CancellationToken.None);
        }
        ...
        public IIdentityRiskEventRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IIdentityRiskEventRequest Expand(Expression<Func<IdentityRiskEvent, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IIdentityRiskEventRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IIdentityRiskEventRequest Select(Expression<Func<IdentityRiskEvent, object>> selectExpression)
        {
