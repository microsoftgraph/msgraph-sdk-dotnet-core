...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class UserCalendarViewCollectionRequest : BaseRequest, IUserCalendarViewCollectionRequest
    {
        /// <summary>
        ...
        public System.Threading.Tasks.Task<IUserCalendarViewCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async System.Threading.Tasks.Task<IUserCalendarViewCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var response = await this.SendAsync<UserCalendarViewCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>The request object to send.</returns>
        public IUserCalendarViewCollectionRequest Expand(Expression<Func<Event, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUserCalendarViewCollectionRequest Select(Expression<Func<Event, object>> selectExpression)
        {
