...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PlannerUserAllCollectionRequest.
    /// </summary>
    public partial class PlannerUserAllCollectionRequest : BaseRequest, IPlannerUserAllCollectionRequest
    {
        /// <summary>
        /// Constructs a new PlannerUserAllCollectionRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PlannerUserAllCollectionRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public IPlannerUserAllCollectionRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPlannerUserAllCollectionRequest Expand(Expression<Func<PlannerDelta, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPlannerUserAllCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPlannerUserAllCollectionRequest Select(Expression<Func<PlannerDelta, object>> selectExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPlannerUserAllCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPlannerUserAllCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPlannerUserAllCollectionRequest Skip(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IPlannerUserAllCollectionRequest OrderBy(string value)
        {
