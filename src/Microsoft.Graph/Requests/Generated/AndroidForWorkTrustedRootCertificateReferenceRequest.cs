...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AndroidForWorkTrustedRootCertificateReferenceRequest.
    /// </summary>
    public partial class AndroidForWorkTrustedRootCertificateReferenceRequest : BaseRequest, IAndroidForWorkTrustedRootCertificateReferenceRequest
    {
        /// <summary>
        /// Constructs a new AndroidForWorkTrustedRootCertificateReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AndroidForWorkTrustedRootCertificateReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified AndroidForWorkTrustedRootCertificate reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified AndroidForWorkTrustedRootCertificate reference.
        /// </summary>
        /// <param name="id">The AndroidForWorkTrustedRootCertificate reference to update.</param>
        /// <returns>The task to await.</returns>
