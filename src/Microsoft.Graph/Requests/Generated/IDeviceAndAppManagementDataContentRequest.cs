...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IDeviceAndAppManagementDataContentRequest.
    /// </summary>
    public partial interface IDeviceAndAppManagementDataContentRequest : IBaseRequest
    {
        /// <summary>
        /// Gets the stream.
        /// </summary>
        ...
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream content) where T : DeviceAndAppManagementData;
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : DeviceAndAppManagementData;
