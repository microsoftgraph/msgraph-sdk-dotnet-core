...
namespace Microsoft.Graph
{
    ...
    public partial class ManagedDeviceMobileAppConfigurationAssignRequestBuilder : BaseActionMethodRequestBuilder<IManagedDeviceMobileAppConfigurationAssignRequest>, IManagedDeviceMobileAppConfigurationAssignRequestBuilder
    {
        ...
        /// <param name="appConfigurationGroupAssignments">A appConfigurationGroupAssignments parameter for the OData method call.</param>
        public ManagedDeviceMobileAppConfigurationAssignRequestBuilder(
            string requestUrl,
            IBaseClient client,
            IEnumerable<MdmAppConfigGroupAssignment> appConfigurationGroupAssignments)
            : base(requestUrl, client)
        {
            this.SetParameter("appConfigurationGroupAssignments", appConfigurationGroupAssignments, true);
        }
        ...
        protected override IManagedDeviceMobileAppConfigurationAssignRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            ...
            if (this.HasParameter("appConfigurationGroupAssignments"))
            {
                request.RequestBody.AppConfigurationGroupAssignments = this.GetParameter<IEnumerable<MdmAppConfigGroupAssignment>>("appConfigurationGroupAssignments");
            }
