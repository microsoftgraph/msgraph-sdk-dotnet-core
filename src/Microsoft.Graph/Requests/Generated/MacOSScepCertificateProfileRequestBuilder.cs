...
namespace Microsoft.Graph
{
    ...
    public partial class MacOSScepCertificateProfileRequestBuilder : MacOSCertificateProfileBaseRequestBuilder, IMacOSScepCertificateProfileRequestBuilder
    {
        ...
        public IMacOSScepCertificateProfileManagedDeviceCertificateStatesCollectionWithReferencesRequestBuilder ManagedDeviceCertificateStates
        {
            get
            {
                return new MacOSScepCertificateProfileManagedDeviceCertificateStatesCollectionWithReferencesRequestBuilder(this.AppendSegmentToRequestUrl("managedDeviceCertificateStates"), this.Client);
            }
        }
