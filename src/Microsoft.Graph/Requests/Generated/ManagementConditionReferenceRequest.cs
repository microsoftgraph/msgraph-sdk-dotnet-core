...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ManagementConditionReferenceRequest.
    /// </summary>
    public partial class ManagementConditionReferenceRequest : BaseRequest, IManagementConditionReferenceRequest
    {
        /// <summary>
        /// Constructs a new ManagementConditionReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ManagementConditionReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified ManagementCondition reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified ManagementCondition reference.
        /// </summary>
        /// <param name="id">The ManagementCondition reference to update.</param>
        /// <returns>The task to await.</returns>
