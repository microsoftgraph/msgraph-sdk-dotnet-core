...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PageContentRequest.
    /// </summary>
    public partial class PageContentRequest : BaseRequest, IPageContentRequest
    {
        /// <summary>
        /// Constructs a new PageContentRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public PageContentRequest(
            string requestUrl,
            IBaseClient client,
