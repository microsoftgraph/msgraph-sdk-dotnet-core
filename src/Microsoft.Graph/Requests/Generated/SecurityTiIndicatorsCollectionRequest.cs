...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type SecurityTiIndicatorsCollectionRequest.
    /// </summary>
    public partial class SecurityTiIndicatorsCollectionRequest : BaseRequest, ISecurityTiIndicatorsCollectionRequest
    {
        /// <summary>
        /// Constructs a new SecurityTiIndicatorsCollectionRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public SecurityTiIndicatorsCollectionRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public ISecurityTiIndicatorsCollectionRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISecurityTiIndicatorsCollectionRequest Expand(Expression<Func<TiIndicator, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISecurityTiIndicatorsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISecurityTiIndicatorsCollectionRequest Select(Expression<Func<TiIndicator, object>> selectExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISecurityTiIndicatorsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISecurityTiIndicatorsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISecurityTiIndicatorsCollectionRequest Skip(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ISecurityTiIndicatorsCollectionRequest OrderBy(string value)
        {
