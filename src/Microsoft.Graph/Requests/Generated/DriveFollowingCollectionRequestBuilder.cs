...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DriveFollowingCollectionRequestBuilder : BaseRequestBuilder, IDriveFollowingCollectionRequestBuilder
    {
        /// <summary>
        ...
        public DriveFollowingCollectionRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public IDriveFollowingCollectionRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public IDriveFollowingCollectionRequest Request(IEnumerable<Option> options)
        {
            return new DriveFollowingCollectionRequest(this.RequestUrl, this.Client, options);
        }
