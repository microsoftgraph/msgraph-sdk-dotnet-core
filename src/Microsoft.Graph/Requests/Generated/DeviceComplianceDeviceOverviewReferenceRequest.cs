...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceComplianceDeviceOverviewReferenceRequest.
    /// </summary>
    public partial class DeviceComplianceDeviceOverviewReferenceRequest : BaseRequest, IDeviceComplianceDeviceOverviewReferenceRequest
    {
        /// <summary>
        /// Constructs a new DeviceComplianceDeviceOverviewReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DeviceComplianceDeviceOverviewReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified DeviceComplianceDeviceOverview reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified DeviceComplianceDeviceOverview reference.
        /// </summary>
        /// <param name="id">The DeviceComplianceDeviceOverview reference to update.</param>
        /// <returns>The task to await.</returns>
