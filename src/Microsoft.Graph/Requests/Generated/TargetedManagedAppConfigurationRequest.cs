    ...
    public partial class TargetedManagedAppConfigurationRequest : BaseRequest, ITargetedManagedAppConfigurationRequest
    {
        ...
        private void InitializeCollectionProperties(TargetedManagedAppConfiguration targetedManagedAppConfigurationToInitialize)
        {
            ...
            if (targetedManagedAppConfigurationToInitialize != null && targetedManagedAppConfigurationToInitialize.AdditionalData != null)
            {
                ...
                if (targetedManagedAppConfigurationToInitialize.TargetedSecurityGroups != null && targetedManagedAppConfigurationToInitialize.TargetedSecurityGroups.CurrentPage != null)
                {
                    targetedManagedAppConfigurationToInitialize.TargetedSecurityGroups.AdditionalData = targetedManagedAppConfigurationToInitialize.AdditionalData;

                    object nextPageLink;
                    targetedManagedAppConfigurationToInitialize.AdditionalData.TryGetValue("targetedSecurityGroups@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        targetedManagedAppConfigurationToInitialize.TargetedSecurityGroups.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
