...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class GroupOwnersCollectionWithReferencesRequestBuilder : BaseRequestBuilder, IGroupOwnersCollectionWithReferencesRequestBuilder
    {
        ...
        public GroupOwnersCollectionWithReferencesRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        {
            return new GroupOwnersCollectionWithReferencesRequest(this.RequestUrl, this.Client, options);
        }
        ...
        public IGroupOwnersCollectionReferencesRequestBuilder References
        {
            get
            {
                return new GroupOwnersCollectionReferencesRequestBuilder(this.AppendSegmentToRequestUrl("$ref"), this.Client);
            }
        }
