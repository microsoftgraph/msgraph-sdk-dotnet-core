...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type UserAppRoleAssignmentsCollectionReferencesRequest.
    /// </summary>
    public partial class UserAppRoleAssignmentsCollectionReferencesRequest : BaseRequest, IUserAppRoleAssignmentsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new UserAppRoleAssignmentsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public UserAppRoleAssignmentsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
