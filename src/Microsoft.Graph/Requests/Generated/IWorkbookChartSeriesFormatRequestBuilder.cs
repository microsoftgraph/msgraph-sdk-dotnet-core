...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IWorkbookChartSeriesFormatRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IWorkbookChartSeriesFormatRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IWorkbookChartSeriesFormatRequest Request(IEnumerable<Option> options);
