...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AndroidForWorkCertificateProfileBaseReferenceRequest.
    /// </summary>
    public partial class AndroidForWorkCertificateProfileBaseReferenceRequest : BaseRequest, IAndroidForWorkCertificateProfileBaseReferenceRequest
    {
        /// <summary>
        /// Constructs a new AndroidForWorkCertificateProfileBaseReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AndroidForWorkCertificateProfileBaseReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The AndroidForWorkCertificateProfileBase reference to update.</param>
        /// <returns>The task to await.</returns>
