...
namespace Microsoft.Graph
{
    ...
    public partial interface IGraphServiceSitesCollectionRequest : IBaseRequest
    {
        ...
        IGraphServiceSitesCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceSitesCollectionRequest Expand(Expression<Func<Site, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceSitesCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceSitesCollectionRequest Select(Expression<Func<Site, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceSitesCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceSitesCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceSitesCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceSitesCollectionRequest OrderBy(string value);
    }
}
