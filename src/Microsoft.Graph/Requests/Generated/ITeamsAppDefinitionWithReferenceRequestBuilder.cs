...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ITeamsAppDefinitionWithReferenceRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        ITeamsAppDefinitionWithReferenceRequest Request();
        ...
        /// <returns>The built request.</returns>
        ITeamsAppDefinitionWithReferenceRequest Request(IEnumerable<Option> options);
        ...
        ITeamsAppDefinitionReferenceRequestBuilder Reference { get; }
