...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ISiteGetByPathRequest : IBaseRequest
    {
        ...
        /// <returns>The task to await for async call.</returns>
        System.Threading.Tasks.Task<Site> PatchAsync(Site site);
        ...
        /// <returns>The task to await for async call.</returns>
        System.Threading.Tasks.Task<Site> PutAsync(Site site);
        ...
        ISiteGetByPathRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        ISiteGetByPathRequest Select(string value);
    }
}
