...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type RoleScopeTagReferenceRequest.
    /// </summary>
    public partial class RoleScopeTagReferenceRequest : BaseRequest, IRoleScopeTagReferenceRequest
    {
        /// <summary>
        /// Constructs a new RoleScopeTagReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public RoleScopeTagReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified RoleScopeTag reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified RoleScopeTag reference.
        /// </summary>
        /// <param name="id">The RoleScopeTag reference to update.</param>
        /// <returns>The task to await.</returns>
