...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IServicePrincipalOwnedObjectsCollectionWithReferencesRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IServicePrincipalOwnedObjectsCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IServicePrincipalOwnedObjectsCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IServicePrincipalOwnedObjectsCollectionReferencesRequestBuilder References { get; }
