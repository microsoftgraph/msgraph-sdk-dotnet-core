...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IGroupLifecyclePolicyRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IGroupLifecyclePolicyRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IGroupLifecyclePolicyRequest Request(IEnumerable<Option> options);
        ...
        IGroupLifecyclePolicyAddGroupRequestBuilder AddGroup(
            string groupId);
        ...
        IGroupLifecyclePolicyRemoveGroupRequestBuilder RemoveGroup(
            string groupId);
