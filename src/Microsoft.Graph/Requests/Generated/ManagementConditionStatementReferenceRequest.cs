...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ManagementConditionStatementReferenceRequest.
    /// </summary>
    public partial class ManagementConditionStatementReferenceRequest : BaseRequest, IManagementConditionStatementReferenceRequest
    {
        /// <summary>
        /// Constructs a new ManagementConditionStatementReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ManagementConditionStatementReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified ManagementConditionStatement reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified ManagementConditionStatement reference.
        /// </summary>
        /// <param name="id">The ManagementConditionStatement reference to update.</param>
        /// <returns>The task to await.</returns>
