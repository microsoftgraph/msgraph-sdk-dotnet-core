...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IWorkbookNamedItemRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IWorkbookNamedItemRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IWorkbookNamedItemRequest Request(IEnumerable<Option> options);
