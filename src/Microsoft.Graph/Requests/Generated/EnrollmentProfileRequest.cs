...
namespace Microsoft.Graph
{
    ...
    public partial class EnrollmentProfileRequest : BaseRequest, IEnrollmentProfileRequest
    {
        ...
        public System.Threading.Tasks.Task<EnrollmentProfile> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The EnrollmentProfile.</returns>
        public async System.Threading.Tasks.Task<EnrollmentProfile> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<EnrollmentProfile> UpdateAsync(EnrollmentProfile enrollmentProfileToUpdate)
        {
            return this.UpdateAsync(enrollmentProfileToUpdate, CancellationToken.None);
        }
