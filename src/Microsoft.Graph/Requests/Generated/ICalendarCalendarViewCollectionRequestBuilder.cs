...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ICalendarCalendarViewCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        ICalendarCalendarViewCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        ICalendarCalendarViewCollectionRequest Request(IEnumerable<Option> options);
