...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ServicePrincipalPoliciesCollectionReferencesRequest.
    /// </summary>
    public partial class ServicePrincipalPoliciesCollectionReferencesRequest : BaseRequest, IServicePrincipalPoliciesCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new ServicePrincipalPoliciesCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ServicePrincipalPoliciesCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
