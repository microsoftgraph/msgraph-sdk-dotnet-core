...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class CalendarEventsCollectionRequest : BaseRequest, ICalendarEventsCollectionRequest
    {
        /// <summary>
        ...
        public System.Threading.Tasks.Task<ICalendarEventsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async System.Threading.Tasks.Task<ICalendarEventsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var response = await this.SendAsync<CalendarEventsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
