...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceAppManagementRequestBuilder : EntityRequestBuilder, IDeviceAppManagementRequestBuilder
    {
        ...
        /// <summary>
        /// Gets the request builder for DeviceAppManagementSyncWindowsStoreForBusinessApps.
        /// </summary>
        /// <returns>The <see cref="IDeviceAppManagementSyncWindowsStoreForBusinessAppsRequestBuilder"/>.</returns>
        public IDeviceAppManagementSyncWindowsStoreForBusinessAppsRequestBuilder SyncWindowsStoreForBusinessApps()
        {
            return new DeviceAppManagementSyncWindowsStoreForBusinessAppsRequestBuilder(
                this.AppendSegmentToRequestUrl("microsoft.graph.syncWindowsStoreForBusinessApps"),
                this.Client);
        }
