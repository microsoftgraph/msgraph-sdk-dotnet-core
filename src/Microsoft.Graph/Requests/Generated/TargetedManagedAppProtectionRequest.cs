    ...
    public partial class TargetedManagedAppProtectionRequest : BaseRequest, ITargetedManagedAppProtectionRequest
    {
        ...
        private void InitializeCollectionProperties(TargetedManagedAppProtection targetedManagedAppProtectionToInitialize)
        {
            ...
            if (targetedManagedAppProtectionToInitialize != null && targetedManagedAppProtectionToInitialize.AdditionalData != null)
            {
                ...
                if (targetedManagedAppProtectionToInitialize.TargetedSecurityGroups != null && targetedManagedAppProtectionToInitialize.TargetedSecurityGroups.CurrentPage != null)
                {
                    targetedManagedAppProtectionToInitialize.TargetedSecurityGroups.AdditionalData = targetedManagedAppProtectionToInitialize.AdditionalData;

                    object nextPageLink;
                    targetedManagedAppProtectionToInitialize.AdditionalData.TryGetValue("targetedSecurityGroups@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        targetedManagedAppProtectionToInitialize.TargetedSecurityGroups.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
