...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IOfficeClientConfigurationRequest.
    /// </summary>
    public partial interface IOfficeClientConfigurationRequest : IBaseRequest
    {
        /// <summary>
        /// Creates the specified OfficeClientConfiguration using PUT.
        /// </summary>
        ...
        System.Threading.Tasks.Task<OfficeClientConfiguration> CreateAsync(OfficeClientConfiguration officeClientConfigurationToCreate);        /// <summary>
        /// Creates the specified OfficeClientConfiguration using PUT.
        /// </summary>
        /// <param name="officeClientConfigurationToCreate">The OfficeClientConfiguration to create.</param>
        ...
        System.Threading.Tasks.Task<OfficeClientConfiguration> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The OfficeClientConfiguration.</returns>
        System.Threading.Tasks.Task<OfficeClientConfiguration> GetAsync(CancellationToken cancellationToken);
        ...
        IOfficeClientConfigurationRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IOfficeClientConfigurationRequest Expand(Expression<Func<OfficeClientConfiguration, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IOfficeClientConfigurationRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IOfficeClientConfigurationRequest Select(Expression<Func<OfficeClientConfiguration, object>> selectExpression);
