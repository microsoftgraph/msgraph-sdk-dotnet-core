...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface INotebookSectionGroupsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        INotebookSectionGroupsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        INotebookSectionGroupsCollectionRequest Request(IEnumerable<Option> options);
