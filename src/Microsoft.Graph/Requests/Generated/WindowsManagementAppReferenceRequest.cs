...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type WindowsManagementAppReferenceRequest.
    /// </summary>
    public partial class WindowsManagementAppReferenceRequest : BaseRequest, IWindowsManagementAppReferenceRequest
    {
        /// <summary>
        /// Constructs a new WindowsManagementAppReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public WindowsManagementAppReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified WindowsManagementApp reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified WindowsManagementApp reference.
        /// </summary>
        /// <param name="id">The WindowsManagementApp reference to update.</param>
        /// <returns>The task to await.</returns>
