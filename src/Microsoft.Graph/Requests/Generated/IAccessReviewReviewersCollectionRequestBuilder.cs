...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IAccessReviewReviewersCollectionRequestBuilder.
    /// </summary>
    public partial interface IAccessReviewReviewersCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IAccessReviewReviewersCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IAccessReviewReviewersCollectionRequest Request(IEnumerable<Option> options);
