...
namespace Microsoft.Graph
{
    ...
    public partial interface IOnenoteSectionsCollectionRequest : IBaseRequest
    {
        ...
        IOnenoteSectionsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IOnenoteSectionsCollectionRequest Expand(Expression<Func<OnenoteSection, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IOnenoteSectionsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IOnenoteSectionsCollectionRequest Select(Expression<Func<OnenoteSection, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IOnenoteSectionsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IOnenoteSectionsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IOnenoteSectionsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IOnenoteSectionsCollectionRequest OrderBy(string value);
    }
}
