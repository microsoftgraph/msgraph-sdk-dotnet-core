...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IWindows81TrustedRootCertificateRequest.
    /// </summary>
    public partial interface IWindows81TrustedRootCertificateRequest : IBaseRequest
    {
        /// <summary>
        ...
        IWindows81TrustedRootCertificateRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IWindows81TrustedRootCertificateRequest Expand(Expression<Func<Windows81TrustedRootCertificate, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IWindows81TrustedRootCertificateRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IWindows81TrustedRootCertificateRequest Select(Expression<Func<Windows81TrustedRootCertificate, object>> selectExpression);
