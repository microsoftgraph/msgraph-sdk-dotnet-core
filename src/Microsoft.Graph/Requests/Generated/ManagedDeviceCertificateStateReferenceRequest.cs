...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ManagedDeviceCertificateStateReferenceRequest.
    /// </summary>
    public partial class ManagedDeviceCertificateStateReferenceRequest : BaseRequest, IManagedDeviceCertificateStateReferenceRequest
    {
        /// <summary>
        /// Constructs a new ManagedDeviceCertificateStateReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ManagedDeviceCertificateStateReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified ManagedDeviceCertificateState reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified ManagedDeviceCertificateState reference.
        /// </summary>
        /// <param name="id">The ManagedDeviceCertificateState reference to update.</param>
        /// <returns>The task to await.</returns>
