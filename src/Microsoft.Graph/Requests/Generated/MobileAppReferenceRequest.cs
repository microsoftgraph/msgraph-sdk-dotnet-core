...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type MobileAppReferenceRequest.
    /// </summary>
    public partial class MobileAppReferenceRequest : BaseRequest, IMobileAppReferenceRequest
    {
        /// <summary>
        /// Constructs a new MobileAppReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public MobileAppReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified MobileApp reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified MobileApp reference.
        /// </summary>
        /// <param name="id">The MobileApp reference to update.</param>
        /// <returns>The task to await.</returns>
