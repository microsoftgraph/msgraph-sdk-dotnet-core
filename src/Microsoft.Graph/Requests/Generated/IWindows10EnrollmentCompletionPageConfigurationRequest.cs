...
namespace Microsoft.Graph
{
    ...
    public partial interface IWindows10EnrollmentCompletionPageConfigurationRequest : IBaseRequest
    {
        ...
        /// <returns>The created Windows10EnrollmentCompletionPageConfiguration.</returns>
        System.Threading.Tasks.Task<Windows10EnrollmentCompletionPageConfiguration> CreateAsync(Windows10EnrollmentCompletionPageConfiguration windows10EnrollmentCompletionPageConfigurationToCreate, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<Windows10EnrollmentCompletionPageConfiguration> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The Windows10EnrollmentCompletionPageConfiguration.</returns>
        System.Threading.Tasks.Task<Windows10EnrollmentCompletionPageConfiguration> GetAsync(CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<Windows10EnrollmentCompletionPageConfiguration> UpdateAsync(Windows10EnrollmentCompletionPageConfiguration windows10EnrollmentCompletionPageConfigurationToUpdate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The updated Windows10EnrollmentCompletionPageConfiguration.</returns>
        System.Threading.Tasks.Task<Windows10EnrollmentCompletionPageConfiguration> UpdateAsync(Windows10EnrollmentCompletionPageConfiguration windows10EnrollmentCompletionPageConfigurationToUpdate, CancellationToken cancellationToken);
