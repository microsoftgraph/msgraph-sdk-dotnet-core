    ...
    public partial class WindowsInformationProtectionRequest : BaseRequest, IWindowsInformationProtectionRequest
    {
        ...
        private void InitializeCollectionProperties(WindowsInformationProtection windowsInformationProtectionToInitialize)
        {
            ...
            if (windowsInformationProtectionToInitialize != null && windowsInformationProtectionToInitialize.AdditionalData != null)
            {
                ...
                if (windowsInformationProtectionToInitialize.AllowedAppLockerFiles != null && windowsInformationProtectionToInitialize.AllowedAppLockerFiles.CurrentPage != null)
                {
                    windowsInformationProtectionToInitialize.AllowedAppLockerFiles.AdditionalData = windowsInformationProtectionToInitialize.AdditionalData;

                    object nextPageLink;
                    windowsInformationProtectionToInitialize.AdditionalData.TryGetValue("allowedAppLockerFiles@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        windowsInformationProtectionToInitialize.AllowedAppLockerFiles.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
