...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type PlanReferenceRequest.
    /// </summary>
    public partial class PlanReferenceRequest : BaseRequest, IPlanReferenceRequest
    {
        /// <summary>
        /// Constructs a new PlanReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public PlanReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified Plan reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified Plan reference.
        /// </summary>
        /// <param name="id">The Plan reference to update.</param>
        /// <returns>The task to await.</returns>
