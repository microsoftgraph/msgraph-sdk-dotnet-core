...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ResourceContentRequest.
    /// </summary>
    public partial class ResourceContentRequest : BaseRequest, IResourceContentRequest
    {
        /// <summary>
        /// Constructs a new ResourceContentRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public ResourceContentRequest(
            string requestUrl,
            IBaseClient client,
