...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceConfigurationUserStateSummaryRequest : BaseRequest, IDeviceConfigurationUserStateSummaryRequest
    {
        ...
        public System.Threading.Tasks.Task<DeviceConfigurationUserStateSummary> CreateAsync(DeviceConfigurationUserStateSummary deviceConfigurationUserStateSummaryToCreate)
        {
            return this.CreateAsync(deviceConfigurationUserStateSummaryToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created DeviceConfigurationUserStateSummary.</returns>
        public async System.Threading.Tasks.Task<DeviceConfigurationUserStateSummary> CreateAsync(DeviceConfigurationUserStateSummary deviceConfigurationUserStateSummaryToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<DeviceConfigurationUserStateSummary> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The DeviceConfigurationUserStateSummary.</returns>
        public async System.Threading.Tasks.Task<DeviceConfigurationUserStateSummary> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<DeviceConfigurationUserStateSummary> UpdateAsync(DeviceConfigurationUserStateSummary deviceConfigurationUserStateSummaryToUpdate)
        {
            return this.UpdateAsync(deviceConfigurationUserStateSummaryToUpdate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The updated DeviceConfigurationUserStateSummary.</returns>
        public async System.Threading.Tasks.Task<DeviceConfigurationUserStateSummary> UpdateAsync(DeviceConfigurationUserStateSummary deviceConfigurationUserStateSummaryToUpdate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "PATCH";
