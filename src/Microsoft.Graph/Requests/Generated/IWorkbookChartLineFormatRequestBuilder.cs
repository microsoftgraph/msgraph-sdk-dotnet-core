...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IWorkbookChartLineFormatRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IWorkbookChartLineFormatRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IWorkbookChartLineFormatRequest Request(IEnumerable<Option> options);
