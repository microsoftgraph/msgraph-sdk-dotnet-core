...
namespace Microsoft.Graph
{
    ...
    public partial interface IApplicationExtensionPropertiesCollectionRequest : IBaseRequest
    {
        ...
        IApplicationExtensionPropertiesCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IApplicationExtensionPropertiesCollectionRequest Expand(Expression<Func<ExtensionProperty, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IApplicationExtensionPropertiesCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IApplicationExtensionPropertiesCollectionRequest Select(Expression<Func<ExtensionProperty, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IApplicationExtensionPropertiesCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IApplicationExtensionPropertiesCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IApplicationExtensionPropertiesCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IApplicationExtensionPropertiesCollectionRequest OrderBy(string value);
    }
}
