...
namespace Microsoft.Graph
{
    ...
    public partial interface IDirectoryRoleScopedMembersCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IDirectoryRoleScopedMembersCollectionPage> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IDirectoryRoleScopedMembersCollectionPage> GetAsync(CancellationToken cancellationToken);
