...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type GovernanceRoleAssignmentReferenceRequest.
    /// </summary>
    public partial class GovernanceRoleAssignmentReferenceRequest : BaseRequest, IGovernanceRoleAssignmentReferenceRequest
    {
        /// <summary>
        /// Constructs a new GovernanceRoleAssignmentReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public GovernanceRoleAssignmentReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The GovernanceRoleAssignment reference to update.</param>
        /// <returns>The task to await.</returns>
