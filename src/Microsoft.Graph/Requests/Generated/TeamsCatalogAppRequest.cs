...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type TeamsCatalogAppRequest.
    /// </summary>
    public partial class TeamsCatalogAppRequest : BaseRequest, ITeamsCatalogAppRequest
    {
        /// <summary>
        /// Constructs a new TeamsCatalogAppRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public TeamsCatalogAppRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified TeamsCatalogApp.
        /// </summary>
        ...
        {
            this.Method = "DELETE";
            await this.SendAsync<TeamsCatalogApp>(null, cancellationToken).ConfigureAwait(false);
        }

        /// <summary>
        /// Gets the specified TeamsCatalogApp.
        /// </summary>
        /// <returns>The TeamsCatalogApp.</returns>
        public System.Threading.Tasks.Task<TeamsCatalogApp> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The TeamsCatalogApp.</returns>
        public async System.Threading.Tasks.Task<TeamsCatalogApp> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var retrievedEntity = await this.SendAsync<TeamsCatalogApp>(null, cancellationToken).ConfigureAwait(false);
        ...
        public System.Threading.Tasks.Task<TeamsCatalogApp> UpdateAsync(TeamsCatalogApp teamsCatalogAppToUpdate)
        {
            return this.UpdateAsync(teamsCatalogAppToUpdate, CancellationToken.None);
        }
        ...
        public ITeamsCatalogAppRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ITeamsCatalogAppRequest Expand(Expression<Func<TeamsCatalogApp, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ITeamsCatalogAppRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ITeamsCatalogAppRequest Select(Expression<Func<TeamsCatalogApp, object>> selectExpression)
        {
