...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceComplianceUserOverviewReferenceRequest.
    /// </summary>
    public partial class DeviceComplianceUserOverviewReferenceRequest : BaseRequest, IDeviceComplianceUserOverviewReferenceRequest
    {
        /// <summary>
        /// Constructs a new DeviceComplianceUserOverviewReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DeviceComplianceUserOverviewReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified DeviceComplianceUserOverview reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified DeviceComplianceUserOverview reference.
        /// </summary>
        /// <param name="id">The DeviceComplianceUserOverview reference to update.</param>
        /// <returns>The task to await.</returns>
