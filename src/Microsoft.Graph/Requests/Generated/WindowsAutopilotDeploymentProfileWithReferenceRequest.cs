...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type WindowsAutopilotDeploymentProfileWithReferenceRequest.
    /// </summary>
    public partial class WindowsAutopilotDeploymentProfileWithReferenceRequest : BaseRequest, IWindowsAutopilotDeploymentProfileWithReferenceRequest
    {
        /// <summary>
        /// Constructs a new WindowsAutopilotDeploymentProfileWithReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public WindowsAutopilotDeploymentProfileWithReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public IWindowsAutopilotDeploymentProfileWithReferenceRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsAutopilotDeploymentProfileWithReferenceRequest Expand(Expression<Func<WindowsAutopilotDeploymentProfile, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsAutopilotDeploymentProfileWithReferenceRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IWindowsAutopilotDeploymentProfileWithReferenceRequest Select(Expression<Func<WindowsAutopilotDeploymentProfile, object>> selectExpression)
        {
