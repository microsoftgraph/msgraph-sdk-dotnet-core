...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class GraphServiceServicePrincipalsCollectionRequest : BaseRequest, IGraphServiceServicePrincipalsCollectionRequest
    {
        /// <summary>
        ...
        public GraphServiceServicePrincipalsCollectionRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<IGraphServiceServicePrincipalsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async System.Threading.Tasks.Task<IGraphServiceServicePrincipalsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var response = await this.SendAsync<GraphServiceServicePrincipalsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
