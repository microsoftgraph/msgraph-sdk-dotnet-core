...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IMessageMultiValueExtendedPropertiesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IMessageMultiValueExtendedPropertiesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IMessageMultiValueExtendedPropertiesCollectionRequest Request(IEnumerable<Option> options);
