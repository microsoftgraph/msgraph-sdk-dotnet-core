...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class DriveItemVersionContentRequest : BaseRequest, IDriveItemVersionContentRequest
    {
        /// <summary>
        ...
        /// </summary>
        public DriveItemVersionContentRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content) where T : DriveItemVersion
        {
        ...
        /// <param name="completionOption">The <see cref="HttpCompletionOption"/> to pass to the <see cref="IHttpProvider"/> on send.</param>
        /// <returns>The object returned by the PUT call.</returns>
        public System.Threading.Tasks.Task<T> PutAsync<T>(Stream content, CancellationToken cancellationToken, HttpCompletionOption completionOption = HttpCompletionOption.ResponseContentRead) where T : DriveItemVersion
        {
