...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IEventExtensionsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<IEventExtensionsCollectionPage> GetAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        System.Threading.Tasks.Task<IEventExtensionsCollectionPage> GetAsync(CancellationToken cancellationToken);
        ...
        /// <returns>The request object to send.</returns>
        IEventExtensionsCollectionRequest Expand(Expression<Func<Extension, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IEventExtensionsCollectionRequest Select(Expression<Func<Extension, object>> selectExpression);
