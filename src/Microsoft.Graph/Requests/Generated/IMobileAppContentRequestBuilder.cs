...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IMobileAppContentRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IMobileAppContentRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IMobileAppContentRequest Request(IEnumerable<Option> options);
