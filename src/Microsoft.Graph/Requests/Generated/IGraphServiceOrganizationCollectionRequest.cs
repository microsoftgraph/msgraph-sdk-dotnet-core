...
namespace Microsoft.Graph
{
    ...
    public partial interface IGraphServiceOrganizationCollectionRequest : IBaseRequest
    {
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceOrganizationCollectionRequest Expand(Expression<Func<Organization, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IGraphServiceOrganizationCollectionRequest Select(Expression<Func<Organization, object>> selectExpression);
