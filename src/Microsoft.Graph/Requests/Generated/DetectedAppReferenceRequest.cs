...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DetectedAppReferenceRequest.
    /// </summary>
    public partial class DetectedAppReferenceRequest : BaseRequest, IDetectedAppReferenceRequest
    {
        /// <summary>
        /// Constructs a new DetectedAppReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DetectedAppReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The DetectedApp reference to update.</param>
        /// <returns>The task to await.</returns>
