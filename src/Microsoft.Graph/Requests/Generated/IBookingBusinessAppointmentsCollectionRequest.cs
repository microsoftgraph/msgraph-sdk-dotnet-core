...
namespace Microsoft.Graph
{
    ...
    public partial interface IBookingBusinessAppointmentsCollectionRequest : IBaseRequest
    {
        ...
        IBookingBusinessAppointmentsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IBookingBusinessAppointmentsCollectionRequest Expand(Expression<Func<BookingAppointment, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IBookingBusinessAppointmentsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IBookingBusinessAppointmentsCollectionRequest Select(Expression<Func<BookingAppointment, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IBookingBusinessAppointmentsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IBookingBusinessAppointmentsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IBookingBusinessAppointmentsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IBookingBusinessAppointmentsCollectionRequest OrderBy(string value);
    }
}
