...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IDriveFollowingCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDriveFollowingCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDriveFollowingCollectionRequest Request(IEnumerable<Option> options);
