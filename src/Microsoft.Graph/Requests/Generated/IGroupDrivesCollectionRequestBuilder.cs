...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IGroupDrivesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IGroupDrivesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IGroupDrivesCollectionRequest Request(IEnumerable<Option> options);
