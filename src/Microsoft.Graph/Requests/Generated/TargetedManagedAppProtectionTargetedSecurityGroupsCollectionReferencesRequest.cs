...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type TargetedManagedAppProtectionTargetedSecurityGroupsCollectionReferencesRequest.
    /// </summary>
    public partial class TargetedManagedAppProtectionTargetedSecurityGroupsCollectionReferencesRequest : BaseRequest, ITargetedManagedAppProtectionTargetedSecurityGroupsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new TargetedManagedAppProtectionTargetedSecurityGroupsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public TargetedManagedAppProtectionTargetedSecurityGroupsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
