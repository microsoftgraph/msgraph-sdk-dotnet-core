...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type NotificationMessageTemplateReferenceRequest.
    /// </summary>
    public partial class NotificationMessageTemplateReferenceRequest : BaseRequest, INotificationMessageTemplateReferenceRequest
    {
        /// <summary>
        /// Constructs a new NotificationMessageTemplateReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public NotificationMessageTemplateReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified NotificationMessageTemplate reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified NotificationMessageTemplate reference.
        /// </summary>
        /// <param name="id">The NotificationMessageTemplate reference to update.</param>
        /// <returns>The task to await.</returns>
