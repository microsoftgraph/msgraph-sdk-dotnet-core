...
namespace Microsoft.Graph
{
    ...
    public partial interface IAndroidWorkProfileCertificateProfileBaseRequestBuilder : IDeviceConfigurationRequestBuilder
    {
        ...
        new IAndroidWorkProfileCertificateProfileBaseRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IAndroidWorkProfileCertificateProfileBaseRequest Request(IEnumerable<Option> options);
        ...
        IAndroidWorkProfileTrustedRootCertificateWithReferenceRequestBuilder RootCertificate { get; }
