...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class UserMessagesCollectionRequest : BaseRequest, IUserMessagesCollectionRequest
    {
        /// <summary>
        ...
        public System.Threading.Tasks.Task<IUserMessagesCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async System.Threading.Tasks.Task<IUserMessagesCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var response = await this.SendAsync<UserMessagesCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>The request object to send.</returns>
        public IUserMessagesCollectionRequest Expand(Expression<Func<Message, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUserMessagesCollectionRequest Select(Expression<Func<Message, object>> selectExpression)
        {
