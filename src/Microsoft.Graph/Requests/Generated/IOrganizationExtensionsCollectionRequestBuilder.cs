...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IOrganizationExtensionsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IOrganizationExtensionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IOrganizationExtensionsCollectionRequest Request(IEnumerable<Option> options);
