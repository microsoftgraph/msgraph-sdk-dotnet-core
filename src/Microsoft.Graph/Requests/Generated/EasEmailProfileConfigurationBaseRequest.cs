...
namespace Microsoft.Graph
{
    ...
    public partial class EasEmailProfileConfigurationBaseRequest : BaseRequest, IEasEmailProfileConfigurationBaseRequest
    {
        ...
        public System.Threading.Tasks.Task<EasEmailProfileConfigurationBase> CreateAsync(EasEmailProfileConfigurationBase easEmailProfileConfigurationBaseToCreate)
        {
            return this.CreateAsync(easEmailProfileConfigurationBaseToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created EasEmailProfileConfigurationBase.</returns>
        public async System.Threading.Tasks.Task<EasEmailProfileConfigurationBase> CreateAsync(EasEmailProfileConfigurationBase easEmailProfileConfigurationBaseToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<EasEmailProfileConfigurationBase> UpdateAsync(EasEmailProfileConfigurationBase easEmailProfileConfigurationBaseToUpdate)
        {
            return this.UpdateAsync(easEmailProfileConfigurationBaseToUpdate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The updated EasEmailProfileConfigurationBase.</returns>
        public async System.Threading.Tasks.Task<EasEmailProfileConfigurationBase> UpdateAsync(EasEmailProfileConfigurationBase easEmailProfileConfigurationBaseToUpdate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "PATCH";
