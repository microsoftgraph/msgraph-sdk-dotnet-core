...
namespace Microsoft.Graph
{
    ...
    public partial class MobileAppInstallStatusRequest : BaseRequest, IMobileAppInstallStatusRequest
    {
        ...
        public System.Threading.Tasks.Task<MobileAppInstallStatus> CreateAsync(MobileAppInstallStatus mobileAppInstallStatusToCreate)
        {
            return this.CreateAsync(mobileAppInstallStatusToCreate, CancellationToken.None);
        }
        ...
        /// <returns>The created MobileAppInstallStatus.</returns>
        public async System.Threading.Tasks.Task<MobileAppInstallStatus> CreateAsync(MobileAppInstallStatus mobileAppInstallStatusToCreate, CancellationToken cancellationToken)
        {
        ...
        public System.Threading.Tasks.Task<MobileAppInstallStatus> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The MobileAppInstallStatus.</returns>
        public async System.Threading.Tasks.Task<MobileAppInstallStatus> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
        ...
        public System.Threading.Tasks.Task<MobileAppInstallStatus> UpdateAsync(MobileAppInstallStatus mobileAppInstallStatusToUpdate)
        {
            return this.UpdateAsync(mobileAppInstallStatusToUpdate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The updated MobileAppInstallStatus.</returns>
        public async System.Threading.Tasks.Task<MobileAppInstallStatus> UpdateAsync(MobileAppInstallStatus mobileAppInstallStatusToUpdate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "PATCH";
