...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ManagedAppPolicyReferenceRequest.
    /// </summary>
    public partial class ManagedAppPolicyReferenceRequest : BaseRequest, IManagedAppPolicyReferenceRequest
    {
        /// <summary>
        /// Constructs a new ManagedAppPolicyReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ManagedAppPolicyReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified ManagedAppPolicy reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified ManagedAppPolicy reference.
        /// </summary>
        /// <param name="id">The ManagedAppPolicy reference to update.</param>
        /// <returns>The task to await.</returns>
