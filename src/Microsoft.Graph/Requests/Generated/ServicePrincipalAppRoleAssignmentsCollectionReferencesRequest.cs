...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ServicePrincipalAppRoleAssignmentsCollectionReferencesRequest.
    /// </summary>
    public partial class ServicePrincipalAppRoleAssignmentsCollectionReferencesRequest : BaseRequest, IServicePrincipalAppRoleAssignmentsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new ServicePrincipalAppRoleAssignmentsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ServicePrincipalAppRoleAssignmentsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
