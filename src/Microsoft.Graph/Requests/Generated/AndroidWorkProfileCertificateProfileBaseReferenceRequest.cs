...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AndroidWorkProfileCertificateProfileBaseReferenceRequest.
    /// </summary>
    public partial class AndroidWorkProfileCertificateProfileBaseReferenceRequest : BaseRequest, IAndroidWorkProfileCertificateProfileBaseReferenceRequest
    {
        /// <summary>
        /// Constructs a new AndroidWorkProfileCertificateProfileBaseReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AndroidWorkProfileCertificateProfileBaseReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The AndroidWorkProfileCertificateProfileBase reference to update.</param>
        /// <returns>The task to await.</returns>
