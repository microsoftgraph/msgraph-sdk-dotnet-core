...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AndroidCertificateProfileBaseReferenceRequest.
    /// </summary>
    public partial class AndroidCertificateProfileBaseReferenceRequest : BaseRequest, IAndroidCertificateProfileBaseReferenceRequest
    {
        /// <summary>
        /// Constructs a new AndroidCertificateProfileBaseReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AndroidCertificateProfileBaseReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified AndroidCertificateProfileBase reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified AndroidCertificateProfileBase reference.
        /// </summary>
        /// <param name="id">The AndroidCertificateProfileBase reference to update.</param>
        /// <returns>The task to await.</returns>
