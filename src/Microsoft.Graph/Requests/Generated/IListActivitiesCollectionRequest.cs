...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IListActivitiesCollectionRequest.
    /// </summary>
    public partial interface IListActivitiesCollectionRequest : IBaseRequest
    {
        ...
        IListActivitiesCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IListActivitiesCollectionRequest Expand(Expression<Func<ItemActivityOLD, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IListActivitiesCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IListActivitiesCollectionRequest Select(Expression<Func<ItemActivityOLD, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IListActivitiesCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IListActivitiesCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IListActivitiesCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IListActivitiesCollectionRequest OrderBy(string value);
    }
}
