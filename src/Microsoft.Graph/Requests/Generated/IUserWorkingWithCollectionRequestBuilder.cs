...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IUserWorkingWithCollectionRequestBuilder.
    /// </summary>
    public partial interface IUserWorkingWithCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IUserWorkingWithCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IUserWorkingWithCollectionRequest Request(IEnumerable<Option> options);
