...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ConnectorReferenceRequest.
    /// </summary>
    public partial class ConnectorReferenceRequest : BaseRequest, IConnectorReferenceRequest
    {
        /// <summary>
        /// Constructs a new ConnectorReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ConnectorReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified Connector reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified Connector reference.
        /// </summary>
        /// <param name="id">The Connector reference to update.</param>
        /// <returns>The task to await.</returns>
