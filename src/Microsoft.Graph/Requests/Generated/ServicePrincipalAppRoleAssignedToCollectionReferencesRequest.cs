...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ServicePrincipalAppRoleAssignedToCollectionReferencesRequest.
    /// </summary>
    public partial class ServicePrincipalAppRoleAssignedToCollectionReferencesRequest : BaseRequest, IServicePrincipalAppRoleAssignedToCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new ServicePrincipalAppRoleAssignedToCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ServicePrincipalAppRoleAssignedToCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
