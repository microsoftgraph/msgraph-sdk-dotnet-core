...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IWorkbookChartSeriesRequestBuilder : IEntityRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        new IWorkbookChartSeriesRequest Request();
        ...
        /// <returns>The built request.</returns>
        new IWorkbookChartSeriesRequest Request(IEnumerable<Option> options);
        ...
        IWorkbookChartSeriesPointsCollectionRequestBuilder Points { get; }
