...
namespace Microsoft.Graph
{
    ...
    public partial interface IChannelTabsCollectionRequest : IBaseRequest
    {
        ...
        IChannelTabsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IChannelTabsCollectionRequest Expand(Expression<Func<TeamsTab, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IChannelTabsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IChannelTabsCollectionRequest Select(Expression<Func<TeamsTab, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IChannelTabsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IChannelTabsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IChannelTabsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IChannelTabsCollectionRequest OrderBy(string value);
    }
}
