...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IPostSingleValueExtendedPropertiesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IPostSingleValueExtendedPropertiesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IPostSingleValueExtendedPropertiesCollectionRequest Request(IEnumerable<Option> options);
