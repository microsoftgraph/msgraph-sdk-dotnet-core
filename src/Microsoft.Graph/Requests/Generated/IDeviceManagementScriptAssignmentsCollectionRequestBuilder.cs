...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IDeviceManagementScriptAssignmentsCollectionRequestBuilder.
    /// </summary>
    public partial interface IDeviceManagementScriptAssignmentsCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IDeviceManagementScriptAssignmentsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IDeviceManagementScriptAssignmentsCollectionRequest Request(IEnumerable<Option> options);
