...
namespace Microsoft.Graph
{
    ...
    public partial class IosVppAppRequestBuilder : MobileAppRequestBuilder, IIosVppAppRequestBuilder
    {
        ...
        /// <summary>
        /// Gets the request builder for VppToken.
        /// </summary>
        /// <returns>The <see cref="IAppleVolumePurchaseProgramTokenWithReferenceRequestBuilder"/>.</returns>
        public IAppleVolumePurchaseProgramTokenWithReferenceRequestBuilder VppToken
        {
            get
            {
                return new AppleVolumePurchaseProgramTokenWithReferenceRequestBuilder(this.AppendSegmentToRequestUrl("vppToken"), this.Client);
            }
        }
