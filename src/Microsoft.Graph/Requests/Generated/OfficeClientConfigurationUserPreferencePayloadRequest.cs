...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type OfficeClientConfigurationUserPreferencePayloadRequest.
    /// </summary>
    public partial class OfficeClientConfigurationUserPreferencePayloadRequest : BaseRequest, IOfficeClientConfigurationUserPreferencePayloadRequest
    {
        /// <summary>
        /// Constructs a new OfficeClientConfigurationUserPreferencePayloadRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public OfficeClientConfigurationUserPreferencePayloadRequest(
            string requestUrl,
            IBaseClient client,
