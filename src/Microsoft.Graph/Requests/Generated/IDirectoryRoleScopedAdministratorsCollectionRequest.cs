...
namespace Microsoft.Graph
{
    ...
    public partial interface IDirectoryRoleScopedAdministratorsCollectionRequest : IBaseRequest
    {
        ...
        /// <returns>The request object to send.</returns>
        IDirectoryRoleScopedAdministratorsCollectionRequest Expand(Expression<Func<ScopedRoleMembership, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IDirectoryRoleScopedAdministratorsCollectionRequest Select(Expression<Func<ScopedRoleMembership, object>> selectExpression);
