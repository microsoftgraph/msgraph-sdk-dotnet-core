...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ContactFolderContactsCollectionPage : CollectionPage<Contact>, IContactFolderContactsCollectionPage
    {
        /// <summary>
        ...
        public void InitializeNextPageRequest(IBaseClient client, string nextPageLinkString)
        {
            ...
            {
                this.NextPageRequest = new ContactFolderContactsCollectionRequest(
                    nextPageLinkString,
                    client,
                    null);
            }
