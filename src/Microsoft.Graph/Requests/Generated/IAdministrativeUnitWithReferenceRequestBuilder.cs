...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IAdministrativeUnitWithReferenceRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IAdministrativeUnitWithReferenceRequest Request();
        ...
        /// <returns>The built request.</returns>
        IAdministrativeUnitWithReferenceRequest Request(IEnumerable<Option> options);
        ...
        IAdministrativeUnitReferenceRequestBuilder Reference { get; }
