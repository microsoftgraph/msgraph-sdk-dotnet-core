...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IMessageExtensionsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IMessageExtensionsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IMessageExtensionsCollectionRequest Request(IEnumerable<Option> options);
