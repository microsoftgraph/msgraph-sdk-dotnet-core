...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IOAuth2PermissionGrantWithReferenceRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IOAuth2PermissionGrantWithReferenceRequest Request();
        ...
        /// <returns>The built request.</returns>
        IOAuth2PermissionGrantWithReferenceRequest Request(IEnumerable<Option> options);
        ...
        IOAuth2PermissionGrantReferenceRequestBuilder Reference { get; }
