...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type SectionCopyToSectionGroupRequestBuilder.
    /// </summary>
    public partial class SectionCopyToSectionGroupRequestBuilder : BaseActionMethodRequestBuilder<ISectionCopyToSectionGroupRequest>, ISectionCopyToSectionGroupRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="SectionCopyToSectionGroupRequestBuilder"/>.
        /// </summary>
        ...
        public SectionCopyToSectionGroupRequestBuilder(
            string requestUrl,
            IBaseClient client,
            string id,
            string groupId,
        ...
        protected override ISectionCopyToSectionGroupRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new SectionCopyToSectionGroupRequest(functionUrl, this.Client, options);
