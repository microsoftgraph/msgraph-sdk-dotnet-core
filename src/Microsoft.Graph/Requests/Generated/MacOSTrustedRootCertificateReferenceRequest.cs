...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type MacOSTrustedRootCertificateReferenceRequest.
    /// </summary>
    public partial class MacOSTrustedRootCertificateReferenceRequest : BaseRequest, IMacOSTrustedRootCertificateReferenceRequest
    {
        /// <summary>
        /// Constructs a new MacOSTrustedRootCertificateReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public MacOSTrustedRootCertificateReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The MacOSTrustedRootCertificate reference to update.</param>
        /// <returns>The task to await.</returns>
