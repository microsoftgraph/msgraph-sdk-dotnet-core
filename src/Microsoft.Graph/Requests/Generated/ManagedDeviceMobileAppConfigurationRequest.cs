    ...
    public partial class ManagedDeviceMobileAppConfigurationRequest : BaseRequest, IManagedDeviceMobileAppConfigurationRequest
    {
        ...
        private void InitializeCollectionProperties(ManagedDeviceMobileAppConfiguration managedDeviceMobileAppConfigurationToInitialize)
        {
            ...
            if (managedDeviceMobileAppConfigurationToInitialize != null && managedDeviceMobileAppConfigurationToInitialize.AdditionalData != null)
            {
                ...
                if (managedDeviceMobileAppConfigurationToInitialize.GroupAssignments != null && managedDeviceMobileAppConfigurationToInitialize.GroupAssignments.CurrentPage != null)
                {
                    managedDeviceMobileAppConfigurationToInitialize.GroupAssignments.AdditionalData = managedDeviceMobileAppConfigurationToInitialize.AdditionalData;

                    object nextPageLink;
                    managedDeviceMobileAppConfigurationToInitialize.AdditionalData.TryGetValue("groupAssignments@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        managedDeviceMobileAppConfigurationToInitialize.GroupAssignments.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
