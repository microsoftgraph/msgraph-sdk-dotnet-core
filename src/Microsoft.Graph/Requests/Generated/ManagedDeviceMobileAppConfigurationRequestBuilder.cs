...
namespace Microsoft.Graph
{
    ...
    public partial class ManagedDeviceMobileAppConfigurationRequestBuilder : EntityRequestBuilder, IManagedDeviceMobileAppConfigurationRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>The <see cref="IManagedDeviceMobileAppConfigurationGroupAssignmentsCollectionRequestBuilder"/>.</returns>
        public IManagedDeviceMobileAppConfigurationGroupAssignmentsCollectionRequestBuilder GroupAssignments
        {
            get
            {
                return new ManagedDeviceMobileAppConfigurationGroupAssignmentsCollectionRequestBuilder(this.AppendSegmentToRequestUrl("groupAssignments"), this.Client);
            }
        }
        ...
        public IManagedDeviceMobileAppConfigurationAssignRequestBuilder Assign(
            IEnumerable<MdmAppConfigGroupAssignment> appConfigurationGroupAssignments = null)
        {
