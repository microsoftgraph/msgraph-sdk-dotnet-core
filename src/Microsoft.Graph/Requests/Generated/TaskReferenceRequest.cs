...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type TaskReferenceRequest.
    /// </summary>
    public partial class TaskReferenceRequest : BaseRequest, ITaskReferenceRequest
    {
        /// <summary>
        /// Constructs a new TaskReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public TaskReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// </summary>
        /// <param name="id">The Task reference to update.</param>
        /// <returns>The task to await.</returns>
