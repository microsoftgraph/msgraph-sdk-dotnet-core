...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IDepMacOSEnrollmentProfileReferenceRequest.
    /// </summary>
    public partial interface IDepMacOSEnrollmentProfileReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="id">The DepMacOSEnrollmentProfile reference reference to update.</param>
        /// <returns>The task to await.</returns>
