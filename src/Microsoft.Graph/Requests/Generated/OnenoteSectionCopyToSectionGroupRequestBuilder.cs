...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class OnenoteSectionCopyToSectionGroupRequestBuilder : BaseActionMethodRequestBuilder<IOnenoteSectionCopyToSectionGroupRequest>, IOnenoteSectionCopyToSectionGroupRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="OnenoteSectionCopyToSectionGroupRequestBuilder"/>.
        /// </summary>
        ...
        protected override IOnenoteSectionCopyToSectionGroupRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new OnenoteSectionCopyToSectionGroupRequest(functionUrl, this.Client, options);
