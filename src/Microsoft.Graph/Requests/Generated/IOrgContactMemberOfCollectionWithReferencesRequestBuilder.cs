...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IOrgContactMemberOfCollectionWithReferencesRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IOrgContactMemberOfCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IOrgContactMemberOfCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IOrgContactMemberOfCollectionReferencesRequestBuilder References { get; }
