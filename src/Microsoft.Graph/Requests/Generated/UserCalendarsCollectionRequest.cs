...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class UserCalendarsCollectionRequest : BaseRequest, IUserCalendarsCollectionRequest
    {
        /// <summary>
        ...
        public System.Threading.Tasks.Task<IUserCalendarsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async System.Threading.Tasks.Task<IUserCalendarsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var response = await this.SendAsync<UserCalendarsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>The request object to send.</returns>
        public IUserCalendarsCollectionRequest Expand(Expression<Func<Calendar, object>> expandExpression)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUserCalendarsCollectionRequest Select(Expression<Func<Calendar, object>> selectExpression)
        {
