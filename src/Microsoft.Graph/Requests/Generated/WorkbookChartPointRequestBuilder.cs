...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookChartPointRequestBuilder : EntityRequestBuilder, IWorkbookChartPointRequestBuilder
    {
        ...
        public WorkbookChartPointRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public new IWorkbookChartPointRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public new IWorkbookChartPointRequest Request(IEnumerable<Option> options)
        {
            return new WorkbookChartPointRequest(this.RequestUrl, this.Client, options);
        }
