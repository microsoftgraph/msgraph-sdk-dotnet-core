...
namespace Microsoft.Graph
{
    ...
    public partial class IosScepCertificateProfileRequestBuilder : IosCertificateProfileBaseRequestBuilder, IIosScepCertificateProfileRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>The <see cref="IIosScepCertificateProfileManagedDeviceCertificateStatesCollectionWithReferencesRequestBuilder"/>.</returns>
        public IIosScepCertificateProfileManagedDeviceCertificateStatesCollectionWithReferencesRequestBuilder ManagedDeviceCertificateStates
        {
            get
            {
                return new IosScepCertificateProfileManagedDeviceCertificateStatesCollectionWithReferencesRequestBuilder(this.AppendSegmentToRequestUrl("managedDeviceCertificateStates"), this.Client);
            }
        }
