...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class GraphServiceGroupsCollectionRequest : BaseRequest, IGraphServiceGroupsCollectionRequest
    {
        /// <summary>
        ...
        public System.Threading.Tasks.Task<IGraphServiceGroupsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async System.Threading.Tasks.Task<IGraphServiceGroupsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            var response = await this.SendAsync<GraphServiceGroupsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
