...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IServicePrincipalMemberOfCollectionWithReferencesRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IServicePrincipalMemberOfCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IServicePrincipalMemberOfCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IServicePrincipalMemberOfCollectionReferencesRequestBuilder References { get; }
