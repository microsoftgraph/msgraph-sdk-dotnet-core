...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IAndroidTrustedRootCertificateReferenceRequest.
    /// </summary>
    public partial interface IAndroidTrustedRootCertificateReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="id">The AndroidTrustedRootCertificate reference reference to update.</param>
        /// <returns>The task to await.</returns>
