...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ConnectorGroupApplicationsCollectionReferencesRequest.
    /// </summary>
    public partial class ConnectorGroupApplicationsCollectionReferencesRequest : BaseRequest, IConnectorGroupApplicationsCollectionReferencesRequest
    {
        /// <summary>
        /// Constructs a new ConnectorGroupApplicationsCollectionReferencesRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ConnectorGroupApplicationsCollectionReferencesRequest(
            string requestUrl,
            IBaseClient client,
