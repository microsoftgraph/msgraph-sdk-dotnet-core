...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IPostMultiValueExtendedPropertiesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IPostMultiValueExtendedPropertiesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IPostMultiValueExtendedPropertiesCollectionRequest Request(IEnumerable<Option> options);
