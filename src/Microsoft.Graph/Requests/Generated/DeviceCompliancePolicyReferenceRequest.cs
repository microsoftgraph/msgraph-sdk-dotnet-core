...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type DeviceCompliancePolicyReferenceRequest.
    /// </summary>
    public partial class DeviceCompliancePolicyReferenceRequest : BaseRequest, IDeviceCompliancePolicyReferenceRequest
    {
        /// <summary>
        /// Constructs a new DeviceCompliancePolicyReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public DeviceCompliancePolicyReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified DeviceCompliancePolicy reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified DeviceCompliancePolicy reference.
        /// </summary>
        /// <param name="id">The DeviceCompliancePolicy reference to update.</param>
        /// <returns>The task to await.</returns>
