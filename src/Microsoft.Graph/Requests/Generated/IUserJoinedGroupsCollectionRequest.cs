...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IUserJoinedGroupsCollectionRequest.
    /// </summary>
    public partial interface IUserJoinedGroupsCollectionRequest : IBaseRequest
    {
        ...
        /// <returns>The request object to send.</returns>
        IUserJoinedGroupsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IUserJoinedGroupsCollectionRequest Select(Expression<Func<Group, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IUserJoinedGroupsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IUserJoinedGroupsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IUserJoinedGroupsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IUserJoinedGroupsCollectionRequest OrderBy(string value);
    }
}
