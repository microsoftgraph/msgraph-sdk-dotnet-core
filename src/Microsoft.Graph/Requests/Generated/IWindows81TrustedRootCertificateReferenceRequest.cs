...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IWindows81TrustedRootCertificateReferenceRequest.
    /// </summary>
    public partial interface IWindows81TrustedRootCertificateReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="id">The Windows81TrustedRootCertificate reference reference to update.</param>
        /// <returns>The task to await.</returns>
