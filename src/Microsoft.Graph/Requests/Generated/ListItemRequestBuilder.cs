...
namespace Microsoft.Graph
{
    ...
    public partial class ListItemRequestBuilder : BaseItemRequestBuilder, IListItemRequestBuilder
    {
        ...
        /// <summary>
        /// Gets the request builder for ColumnSet.
        /// </summary>
        /// <returns>The <see cref="IFieldValueSetRequestBuilder"/>.</returns>
        public IFieldValueSetRequestBuilder ColumnSet
        {
            get
            {
                return new FieldValueSetRequestBuilder(this.AppendSegmentToRequestUrl("columnSet"), this.Client);
            }
        }
