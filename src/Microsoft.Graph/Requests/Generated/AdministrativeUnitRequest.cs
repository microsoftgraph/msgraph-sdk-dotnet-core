    ...
    public partial class AdministrativeUnitRequest : BaseRequest, IAdministrativeUnitRequest
    {
        ...
        private void InitializeCollectionProperties(AdministrativeUnit administrativeUnitToInitialize)
        {
            ...
            if (administrativeUnitToInitialize != null && administrativeUnitToInitialize.AdditionalData != null)
            {
                ...
                if (administrativeUnitToInitialize.ScopedAdministrators != null && administrativeUnitToInitialize.ScopedAdministrators.CurrentPage != null)
                {
                    administrativeUnitToInitialize.ScopedAdministrators.AdditionalData = administrativeUnitToInitialize.AdditionalData;

                    object nextPageLink;
                    administrativeUnitToInitialize.AdditionalData.TryGetValue("scopedAdministrators@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        administrativeUnitToInitialize.ScopedAdministrators.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
