...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IOnenotePagesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IOnenotePagesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IOnenotePagesCollectionRequest Request(IEnumerable<Option> options);
