...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IMobileAppCategoriesCollectionRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IMobileAppCategoriesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IMobileAppCategoriesCollectionRequest Request(IEnumerable<Option> options);
