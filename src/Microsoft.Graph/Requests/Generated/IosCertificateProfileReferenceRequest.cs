...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type IosCertificateProfileReferenceRequest.
    /// </summary>
    public partial class IosCertificateProfileReferenceRequest : BaseRequest, IIosCertificateProfileReferenceRequest
    {
        /// <summary>
        /// Constructs a new IosCertificateProfileReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public IosCertificateProfileReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified IosCertificateProfile reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified IosCertificateProfile reference.
        /// </summary>
        /// <param name="id">The IosCertificateProfile reference to update.</param>
        /// <returns>The task to await.</returns>
