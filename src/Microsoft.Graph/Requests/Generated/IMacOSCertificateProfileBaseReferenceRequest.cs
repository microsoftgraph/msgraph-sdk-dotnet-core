...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IMacOSCertificateProfileBaseReferenceRequest.
    /// </summary>
    public partial interface IMacOSCertificateProfileBaseReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="id">The MacOSCertificateProfileBase reference reference to update.</param>
        /// <returns>The task to await.</returns>
