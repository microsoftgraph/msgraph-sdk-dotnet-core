...
namespace Microsoft.Graph
{
    ...
    public partial interface IIosManagedAppProtectionAppsCollectionRequest : IBaseRequest
    {
        ...
        IIosManagedAppProtectionAppsCollectionRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        IIosManagedAppProtectionAppsCollectionRequest Expand(Expression<Func<ManagedMobileApp, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        IIosManagedAppProtectionAppsCollectionRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        IIosManagedAppProtectionAppsCollectionRequest Select(Expression<Func<ManagedMobileApp, object>> selectExpression);
        ...
        /// <returns>The request object to send.</returns>
        IIosManagedAppProtectionAppsCollectionRequest Top(int value);
        ...
        /// <returns>The request object to send.</returns>
        IIosManagedAppProtectionAppsCollectionRequest Filter(string value);
        ...
        /// <returns>The request object to send.</returns>
        IIosManagedAppProtectionAppsCollectionRequest Skip(int value);
        ...
        /// <returns>The request object to send.</returns>
        IIosManagedAppProtectionAppsCollectionRequest OrderBy(string value);
    }
}
