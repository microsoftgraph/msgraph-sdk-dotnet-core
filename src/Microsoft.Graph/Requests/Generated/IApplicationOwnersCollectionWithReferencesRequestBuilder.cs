...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IApplicationOwnersCollectionWithReferencesRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IApplicationOwnersCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IApplicationOwnersCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IApplicationOwnersCollectionReferencesRequestBuilder References { get; }
