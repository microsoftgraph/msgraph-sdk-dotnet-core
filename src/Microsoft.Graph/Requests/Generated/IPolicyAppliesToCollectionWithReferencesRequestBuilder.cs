...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IPolicyAppliesToCollectionWithReferencesRequestBuilder.
    /// </summary>
    public partial interface IPolicyAppliesToCollectionWithReferencesRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IPolicyAppliesToCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IPolicyAppliesToCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IPolicyAppliesToCollectionReferencesRequestBuilder References { get; }
