...
namespace Microsoft.Graph
{
    ...
    public partial class EventSingleValueExtendedPropertiesCollectionRequest : BaseRequest, IEventSingleValueExtendedPropertiesCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<IEventSingleValueExtendedPropertiesCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async System.Threading.Tasks.Task<IEventSingleValueExtendedPropertiesCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
