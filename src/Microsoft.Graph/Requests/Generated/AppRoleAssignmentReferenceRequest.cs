...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AppRoleAssignmentReferenceRequest.
    /// </summary>
    public partial class AppRoleAssignmentReferenceRequest : BaseRequest, IAppRoleAssignmentReferenceRequest
    {
        /// <summary>
        /// Constructs a new AppRoleAssignmentReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AppRoleAssignmentReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified AppRoleAssignment reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified AppRoleAssignment reference.
        /// </summary>
        /// <param name="id">The AppRoleAssignment reference to update.</param>
        /// <returns>The task to await.</returns>
