...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IPostAttachmentsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IPostAttachmentsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IPostAttachmentsCollectionRequest Request(IEnumerable<Option> options);
