...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IEducationSchoolUsersCollectionWithReferencesRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IEducationSchoolUsersCollectionWithReferencesRequest Request();
        ...
        /// <returns>The built request.</returns>
        IEducationSchoolUsersCollectionWithReferencesRequest Request(IEnumerable<Option> options);
        ...
        IEducationSchoolUsersCollectionReferencesRequestBuilder References { get; }
