...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type MobileContainedAppReferenceRequest.
    /// </summary>
    public partial class MobileContainedAppReferenceRequest : BaseRequest, IMobileContainedAppReferenceRequest
    {
        /// <summary>
        /// Constructs a new MobileContainedAppReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public MobileContainedAppReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified MobileContainedApp reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified MobileContainedApp reference.
        /// </summary>
        /// <param name="id">The MobileContainedApp reference to update.</param>
        /// <returns>The task to await.</returns>
