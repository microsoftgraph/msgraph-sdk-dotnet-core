...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IWindowsInformationProtectionProtectedAppLockerFilesCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IWindowsInformationProtectionProtectedAppLockerFilesCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IWindowsInformationProtectionProtectedAppLockerFilesCollectionRequest Request(IEnumerable<Option> options);
