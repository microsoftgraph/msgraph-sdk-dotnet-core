...
namespace Microsoft.Graph
{
    ...
    public partial class UserWipeManagedAppRegistrationsByDeviceTagRequest : BaseRequest, IUserWipeManagedAppRegistrationsByDeviceTagRequest
    {
        ...
        /// </summary>
        public UserWipeManagedAppRegistrationsByDeviceTagRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new UserWipeManagedAppRegistrationsByDeviceTagRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public UserWipeManagedAppRegistrationsByDeviceTagRequestBody RequestBody { get; private set; }
        ...
        public IUserWipeManagedAppRegistrationsByDeviceTagRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IUserWipeManagedAppRegistrationsByDeviceTagRequest Select(string value)
        {
